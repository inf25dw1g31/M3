...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      setError(null);
      try {
        const [veiculos, clientes, reservas, manutencoes, categorias] = await Promise.all([
        ...
        // Contar veículos por estado (CORRETO)
        const veiculosDisponiveis = veiculos.data.filter(v => v.estado === 'Disponivel').length;
        const veiculosAlugados = veiculos.data.filter(v => v.estado === 'Alugado').length;
        const veiculosEmManutencao = veiculos.data.filter(v => v.estado === 'Manutencao').length;
        ...
        setStats({
          ...
          manutencoes: manutencoes.total || manutencoes.data.length,
  ...
  // Calcular taxa de ocupação correta
  const veiculosOperacionais = stats.veiculos - stats.veiculosEmManutencao;
  const taxaOcupacao = veiculosOperacionais > 0 
    ? Math.round((stats.veiculosAlugados / veiculosOperacionais) * 100)
    : 0;
          ...
          <StatsCard 
            ...
            items={[
              ...
              },
              {
                ...
                subtitle: 'Em uso pelos clientes',
              ...
              },
              {
                ...
                value: stats.veiculosEmManutencao,
                color: '#f5576c',
              },
              {
                icon: CategoryIcon,
          ...
          <StatsCard 
            ...
            items={[
              ...
              },
              {
                ...
                subtitle: `${stats.veiculosAlugados} de ${veiculosOperacionais} operacionais`,
                value: `${taxaOcupacao}%`,
                color: '#f093fb',
              },
            ]}
